 ...
 * strings is an array
 * return a new array 
 * with the same length as 'strings' array
 * lowercase version of each string
 * 
 * 
 * Examples of usage of this function:
 * [1] Invoking `lowerCaseStrings` with `[ 'Orange', 'APPLE', 'banana', 'mAnGo']` 
 * will return `[ 'orange', 'apple', 'banana', 'mango' ]`.
 * 
...
function lowerCaseStrings(strings) {
  ...
  strings.forEach(function(string){
    fruits.push(string.toLowerCase());
  })
  return fruits;
}
...
function removeApple(strings) {
  return strings.filter(function(fruit){
    return fruit !== 'apple';
  })
}
 ...
 * 
 *  counter 1 declares a variable using let inside of the function scope and counter 2 declares the variable globally.
 * 
 * 2. Which of the two uses a closure? How can you tell?
 * 
 * counter 1 because when the function is run using (); it's accessing let count = 0;
 * 
 * 3. In what scenario would the counter1 code be preferable? In what scenario would counter2 be better? 
 * 
 *
 * counter 1 is better in cases where you have a lot of variables in order to prevent them from interfering with each other. counter 2 is better if you have a small program which 
 * needs global variables that are used a lot.
 * 
*/
